...
public class CustomerTM {
    ...
    public CustomerTM(String id, String name, String age, String nicNumber, String email, String address, String mobileNumber, String date, String time, String duration, String selectedPackage, String selectedRoom, String selectedMeals, String totalCost, Button btn) {
        this.setId(id);
        this.setName(name);
        this.setAge(age);
